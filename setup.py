...
setup(
    ...
    entry_points={
        ...
        'TestAnyBlok': [
            'test-blok1=anyblok.tests.test_blok1:TestBlok',
            'test-blok2=anyblok.tests.test_blok2:TestBlok',
            'test-blok3=anyblok.tests.test_blok3:TestBlok',
            'test-blok4=anyblok.tests.test_blok4:TestBlok',
            'test-blok5=anyblok.tests.test_blok5:TestBlok',
            'test-blok6=anyblok.tests.test_blok6:TestBlok',
            'test-blok7=anyblok.tests.test_blok7:TestBlok',
            'test-blok8=anyblok.tests.test_blok8:TestBlok',
        ],
    },
    extras_require={},
)
