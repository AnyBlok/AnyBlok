...
class TestImporterFormater(BlokTestCase):
    ...
    def test_json(self):
        import json
        value = self.get_value(json.dumps({'id': 1}), "Json")
    ...
    def test_many2many(self):
        ...
        value = self.get_value(
            json.dumps([pks]), "Many2Many", model="Model.System.Model")
    ...
    def test_many2many_multi_value(self):
        ...
        value = self.get_value(
            json.dumps([pks1, pks2]), "Many2Many", model="Model.System.Model")
    ...
    def test_one2many(self):
        ...
        model = self.registry.System.Model.from_primary_keys(**pks)
        value = self.get_value(
            json.dumps([pks]), "One2Many", model="Model.System.Model")
        self.assertEqual(value, [model])
    ...
    def test_one2many_multi_value(self):
        ...
        model2 = self.registry.System.Model.from_primary_keys(**pks2)
        value = self.get_value(
            json.dumps([pks1, pks2]), "One2Many", model="Model.System.Model")
        self.assertEqual(value, [model1, model2])
    ...
    def test_one2many_multi_value_external_ids(self):
        ...
        self.registry.IO.Mapping.set(key1, model1)
        self.registry.IO.Mapping.set(key2, model2)
        value = self.get_value(json.dumps([key1, key2]), "One2Many",
    ...
    def test_many2one(self):
        ...
        model = self.registry.System.Model.from_primary_keys(**pks)
        value = self.get_value(
            json.dumps(pks), "Many2One", model="Model.System.Model")
        self.assertEqual(value, model)
    ...
    def test_one2one(self):
        ...
        model = self.registry.System.Model.from_primary_keys(**pks)
        value = self.get_value(
            json.dumps(pks), "One2One", model="Model.System.Model")
        self.assertEqual(value, model)
